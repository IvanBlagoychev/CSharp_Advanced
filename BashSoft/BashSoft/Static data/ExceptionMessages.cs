namespace BashSoft
{
    public static class ExceptionMessages
    {
        ...
        public const string UnathorizedAccessExceptionMessage = "The folder/file you are trying to get access needs a higher level of rights than you currently have.";

        public const string CompariosnOfFilesWithDifferentSizes = "Files not of equal size, certain mismatch.";
